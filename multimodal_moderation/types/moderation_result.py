...
class AudioModerationResult(ModerationResult):
    ...
    is_unfriendly: bool = Field(description="Whether the tone or content is unfriendly")
    is_unprofessional: bool = Field(description="Whether the tone or content is unprofessional")
